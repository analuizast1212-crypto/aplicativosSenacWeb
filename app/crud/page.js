    ...
    <div className="min-h-screen bg-black flex flex-col items-center justify-center p-6 gap-6">
      ...
      <div className="bg-white shadow-md rounded-xl p-5 w-full max-w-md">
        <div className="flex flex-col gap-2">
          <input
            className="border p-2 rounded text-black placeholder-black focus:outline-none focus:ring-2 focus:ring-blue-400"
            placeholder="Nome"
            value={nome}
      ...
      {/* TABELA */}
      {alunos.length > 0 && (
        <div className="bg-black shadow-md rounded-xl p-5 w-full max-w-4xl overflow-x-auto">
          ...
          <table className="w-full text-center border-collapse">
            ...
            <tbody>
              {alunos.map((a, i) => (
                <tr key={i} className="border-b hover:bg-gray-800 text-white">
